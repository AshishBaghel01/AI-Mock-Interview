...
function Pricing() {
  ...
  return (
    <Motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.75 }} className='min-h-screen py-16 px-6'>
          ...
          return (
            <Motion.div key={plan.id}
              ...
              className={`relative rounded-3xl p-8 transition-all duration-300 border 
                ${isSelected
                  ? "border-green-500 shadow-2xl bg-white"
            ...
            >
              ...
              {/* Badge */}
              {plan.badge && (
                <div className="absolute top-6 right-6 bg-green-500 text-white text-xs px-4 py-1 rounded-full shadow">
                  {plan.badge}
                </div>
              )}
