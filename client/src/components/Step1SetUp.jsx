                    ...
                    <div className='space-y-6'>
                        ...
                        <select value={mode}
                            onChange={(e) => setMode(e.target.value)}
                                className='w-full py-3 px-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-600 outline-none transition'>
                                ...
                                {skills.length > 0 && (
                                    <div>
                                        ...
                                        <div className='flex flex-wrap gap-2'>
                                            {skills.map((s, i) => (
                                                <span key={i} className='bg-green-100 text-green-600 px-3 py-1 rounded-full text-sm'>{s}</span>
                                            ))}
                                        </div>
                                    </div>
                                )}
                        ...
                        onClick={handleStart}
                            ...
                            whileHover={{ scale: 1.03 }}
                            whileTap={{ scale: 0.95 }}
                            className='w-full disabled:bg-gray-600 bg-green-500 hover:bg-green-500 text-white py-3 rounded-full text-lg font-semibold transition duration-300 shadow-md'>
